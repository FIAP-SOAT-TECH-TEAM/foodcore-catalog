package com.soat.fiap.food.core.catalog.order.unit.mappers;
...
import com.soat.fiap.food.core.catalog.order.core.application.inputs.CreateOrderInput;
import com.soat.fiap.food.core.catalog.order.core.application.inputs.mappers.CreateOrderMapper;
import com.soat.fiap.food.core.catalog.order.core.domain.model.Order;
import com.soat.fiap.food.core.catalog.order.infrastructure.in.web.api.dto.request.CreateOrderRequest;
import com.soat.fiap.food.core.catalog.order.infrastructure.in.web.api.dto.request.OrderItemRequest;
import com.soat.fiap.food.core.catalog.shared.core.interfaceadapters.gateways.AuthenticatedUserGateway;
